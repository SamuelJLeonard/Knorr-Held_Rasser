...
## INSTRUCTIONS: ##
  ...
  ##  1.  Download the 'Knorr Held Functions.R' file from my GitHub repository, if you haven't already.  
  ##  2.  Run the first two lines of code below.  Select the "Knorr Held Functions.R" file when prompted.
  ##  3.  You can now run the algorithm.  This is the code under the MCMC heading.  I have set 10,000 iterations
  ##      after 10,000 burn-in.  The algorithm will take about 3 minutes to run.
  ##  4.  You can use code under the RESULTS heading to view the some of the MCMC results.  This is a small run, so 
